...
LOOP_TIME = 300000  # milliseconds between spawning new quiz windows
FACTOR_FAIL = 0.75
FACTOR_SUCCESS = 1.5
MAX_GROWTH = 0
GROWTH_INTERVAL = 30000
POLUTION_LIMITER = 15
...
class QuizApplication:
    ...
    def schedule_quiz(self):
        for _ in range(POLUTION_LIMITER):
            if len(self.open_entries) >= POLUTION_LIMITER:
                break
